...
module.exports = async (client, options) => {
  ...
  const logChannel = (options && options.logChannel) || "auto-mute-logs"; // Default value: "AhtiSpam-logs". Explication: This is the channel where every report about spamming goes to. If it's not set up, it will attempt to create the channel.
